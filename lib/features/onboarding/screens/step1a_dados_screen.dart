...
class _Step1aDadosScreenState extends State<Step1aDadosScreen> {
  ...
  void _onCpfChanged(String v) {
    ...
    String masked = n;
    if (n.length > 3) {
      masked = '${n.substring(0, 3)}.${n.substring(3)}';
    }
    if (n.length > 6) {
      masked = '${n.substring(0, 3)}.${n.substring(3, 6)}.${n.substring(6)}';
    }
    if (n.length > 9) {
      masked =
          '${n.substring(0, 3)}.${n.substring(3, 6)}.${n.substring(6, 9)}-${n.substring(9, n.length > 11 ? 11 : n.length)}';
    }
  ...
  void _onTelefoneChanged(String v) {
    ...
    String masked = n;
    if (n.length > 2) {
      masked = '(${n.substring(0, 2)}) ${n.substring(2)}';
    }
    if (n.length > 7) {
      masked =
          '(${n.substring(0, 2)}) ${n.substring(2, 7)}-${n.substring(7, n.length > 11 ? 11 : n.length)}';
    }
      ...
      child: Form(
        ...
        child: ListView(
          children: [
            ...
            const Text(
              'Vamos configurar seu perfil médico.',
                  ...
                  TextFormField(
                    ...
                    decoration: _decor('Mínimo 8 caracteres').copyWith(
                      suffixIcon: IconButton(
                        ...
                        onPressed: () =>
                            set(() => _obscureSenha = !_obscureSenha),
                      ),
                    ),
                    validator: (v) {
