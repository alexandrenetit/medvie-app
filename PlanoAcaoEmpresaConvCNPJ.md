...
- ⚠ NBS dos tipos CNPJ atribuídos em `servico.dart:52` (`40119`/`40101`/`40201`) — **validação oficial pendente** antes de produção (F4.T4.3). Códigos não são mais placeholders textuais, mas precisão depende da tabela NBS vigente (CONFAZ/Receita). Decisão final pode exigir task futura.
